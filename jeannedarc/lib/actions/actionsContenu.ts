...
export async function createContenuTitreAction(data: unknown, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to create contenu titre" };
  }
}

export async function updateContenuTitreAction(id: string, data: unknown, url?:string) {
  if (!id) {
  ...
  try {
    ...
    return { error: "Failed to update contenu titre" };
  }
}
...
export async function deleteContenuTitreAction(id: string, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to delete contenu titre" };
  }
}
...
export async function createContenuImageAction(data: unknown, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to create contenu image" };
  }
}

export async function updateContenuImageAction(id: string, data: unknown, url?:string) {
  if (!id) {
    return { error: "Invalid ID" };
  }
  ...
  try {
    ...
    return { error: "Failed to update contenu image" };
  }
}
...
export async function deleteContenuImageAction(id: string, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to delete contenu image" };
  }
}
...
export async function createContenuTexteAction(data: unknown, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to create contenu texte" };
  }
}

export async function updateContenuTexteAction(id: string, data: unknown, url?:string) {
   if (!id) {
    return { error: "Invalid ID" };
  }
  ...
  try {
    ...
    return { error: "Failed to update contenu texte" };
  }
}
...
export async function deleteContenuTexteAction(id: string, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to delete contenu texte" };
  }
}
...
export async function createContenuContactAction(data: unknown, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to create contenu contact" };
  }
}

export async function updateContenuContactAction(id: string, data: unknown, url?:string) {
  if (!id) {
    return { error: "Invalid ID" };
  }
  ...
  try {
    ...
    return { error: "Failed to update contenu contact" };
  }
}
...
export async function deleteContenuContactAction(id: string, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to delete contenu contact" };
  }
}
...
export async function createContenuPdfAction(data: unknown, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to create contenu pdf" };
  }
}

export async function updateContenuPdfAction(id: string, data: unknown, url?:string) {
  if (!id) {
    return { error: "Invalid ID" };
  }
  ...
  try {
    ...
    return { error: "Failed to update contenu pdf" };
  }
}
...
export async function deleteContenuPdfAction(id: string, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to delete contenu pdf" };
  }
}
...
export async function createContenuPaveAction(data: unknown, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to create contenu pave" };
  }
}

export async function updateContenuPaveAction(id: string, data: unknown, url?:string) {
  if (!id) {
    return { error: "Invalid ID" };
  }
  ...
  try {
    ...
    return { error: "Failed to update contenu pave" };
  }
}
...
export async function deleteContenuPaveAction(id: string, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to delete contenu pave" };
  }
}

// contenu_BANDEAUBTN
export async function createContenuBandeauBtnAction(data: unknown, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to create contenu bandeau btn" };
  }
}

export async function updateContenuBandeauBtnAction(id: string, data: unknown, url?:string) {
  if (!id) {
    return { error: "Invalid ID" };
  }
  ...
  try {
    ...
    return { error: "Failed to update contenu bandeau btn" };
  }
}
...
export async function deleteContenuBandeauBtnAction(id: string, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to delete contenu bandeau btn" };
  }
}

// contenu_HEADERBTN
export async function createContenuHeaderBtnAction(data: unknown, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to create contenu header btn" };
  }
}

export async function updateContenuHeaderBtnAction(id: string, data: unknown, url?:string) {
  if (!id) {
    return { error: "Invalid ID" };
  }
  ...
  try {
    ...
    return { error: "Failed to update contenu header btn" };
  }
}
...
export async function deleteContenuHeaderBtnAction(id: string, url?:string) {
  ...
  try {
    ...
    return { error: "Failed to delete contenu header btn" };
  }
}