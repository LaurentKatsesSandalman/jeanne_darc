...
export const ContenuTexteSchema = z.object({
    ...
    id_section_fk: z.uuid(),
    tiptap_content: z.custom<JSONContent>(
        (val) => {
...
export const UpdateContenuBandeauBtnSchema =
    CreateContenuBandeauBtnSchema.partial();

// ===== CONTENU_SOLOBTN =====
export const ContenuSoloBtnSchema = z.object({
    id_contenu_solobtn: z.uuid(),
    id_section_fk: z.uuid(),
    bouton: z.string().min(1),
    lien_vers: z.string().min(1),
    created_at: z.date(),
...
export const CreateContenuSoloBtnSchema = ContenuSoloBtnSchema.omit({
    id_contenu_solobtn: true,
    created_at: true,
    updated_at: true,
});

export const UpdateContenuSoloBtnSchema = CreateContenuSoloBtnSchema.partial();
...
export const UpdateContenuHeaderBtnSchema =
    CreateContenuHeaderBtnSchema.partial();
...
export const PaveBlocSchema = z.object({
    ...
    description5: z.string(),
    description6: z.string(),
    description7: z.string(),
    lien_vers: z.string(),
    created_at: z.date(),
    updated_at: z.date(),
});
...
export type CreateUpdatePageResult =
    | { success: true; data: PageInterface }
    | { success: false; error: string }
    | { success: false; errors: unknown };
...
export type CreateUpdateSectionResult =
    | { success: true; data: SectionInterface }
    | { success: false; error: string }
    | { success: false; errors: unknown };
...
export type CreateUpdateContenuImageResult =
    | { success: true; data: ContenuImageInterface }
    | { success: false; error: string }
    | { success: false; errors: unknown };
...
export type CreateUpdateContenuTexteResult =
    | { success: true; data: ContenuTexteInterface }
    | { success: false; error: string }
    | { success: false; errors: unknown };
// WARNING
...
export type CreateUpdateContenuContactResult =
    | { success: true; data: ContenuContactInterface }
    | { success: false; error: string }
    | { success: false; errors: unknown };
...
export type CreateUpdateContenuPdfResult =
    | { success: true; data: ContenuPdfInterface }
    | { success: false; error: string }
    | { success: false; errors: unknown };
...
export type CreateUpdateContenuTitreResult =
    | { success: true; data: ContenuTitreInterface }
    | { success: false; error: string }
    | { success: false; errors: unknown };
...
export type CreateUpdateContenuPaveResult =
    | { success: true; data: ContenuPaveInterface }
    | { success: false; error: string }
    | { success: false; errors: unknown };

export type ContenuBandeauBtnInterface = z.infer<
    typeof ContenuBandeauBtnSchema
>;
export type CreateContenuBandeauBtn = z.infer<
    typeof CreateContenuBandeauBtnSchema
>;
export type UpdateContenuBandeauBtn = z.infer<
    typeof UpdateContenuBandeauBtnSchema
>;
export type CreateUpdateContenuBandeauBtnResult =
    | { success: true; data: ContenuBandeauBtnInterface }
    | { success: false; error: string }
    | { success: false; errors: unknown };

export type ContenuSoloBtnInterface = z.infer<typeof ContenuSoloBtnSchema>;
export type CreateContenuSoloBtn = z.infer<typeof CreateContenuSoloBtnSchema>;
export type UpdateContenuSoloBtn = z.infer<typeof UpdateContenuSoloBtnSchema>;
export type CreateUpdateContenuSoloBtnResult =
    | { success: true; data: ContenuSoloBtnInterface }
    | { success: false; error: string }
    | { success: false; errors: unknown };

export type ContenuHeaderBtnInterface = z.infer<typeof ContenuHeaderBtnSchema>;
export type CreateContenuHeaderBtn = z.infer<
    typeof CreateContenuHeaderBtnSchema
>;
export type UpdateContenuHeaderBtn = z.infer<
    typeof UpdateContenuHeaderBtnSchema
>;
export type CreateUpdateContenuHeaderBtnResult =
    | { success: true; data: ContenuHeaderBtnInterface }
    | { success: false; error: string }
    | { success: false; errors: unknown };
...
export type CreateUpdatePaveBlocResult =
