...
import { sql } from './db';
import { ContenuTexteInterface, PageInterface } from './definitions';

export async function createPage(payload:Omit<PageInterface, "id_page">):Promise<PageInterface |undefined>{
...
export async function updatePageById(payload:Partial<Omit<PageInterface, "id_page">>,id:string): Promise<PageInterface | undefined> {
