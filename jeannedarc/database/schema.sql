...
CREATE TABLE contenu_contact (
    ...
    champ1 TEXT NOT NULL DEFAULT '',
    champ2 TEXT NOT NULL DEFAULT '',
    champ3 TEXT NOT NULL DEFAULT '',
    champ4 TEXT NOT NULL DEFAULT '',
...
CREATE TABLE contenu_titre (
    ...
    titre1 TEXT NOT NULL DEFAULT '',
    titre2 TEXT NOT NULL DEFAULT '',
