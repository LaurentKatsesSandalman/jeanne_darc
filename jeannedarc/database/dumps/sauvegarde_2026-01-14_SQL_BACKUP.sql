...
\restrict jtA7julIgSTFhHDo9l67Iy6vqJbfbdRHD8tSFmy1hdFvgdHgaqjGMOkLbYbsE8f
...
CREATE TABLE public.contenu_bandeaubtn (
    ...
    icone text DEFAULT ''::text CONSTRAINT contenu_bandeaubtn_icone_url_not_null NOT NULL,
...
CREATE TABLE public.pave_bloc (
    ...
    icone text DEFAULT ''::text CONSTRAINT pave_bloc_icone_url_not_null NOT NULL,
    soustitre text DEFAULT ''::text NOT NULL,
    description1 text DEFAULT ''::text CONSTRAINT pave_bloc_description_not_null NOT NULL,
    lien_vers text DEFAULT ''::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
...
\unrestrict jtA7julIgSTFhHDo9l67Iy6vqJbfbdRHD8tSFmy1hdFvgdHgaqjGMOkLbYbsE8f
